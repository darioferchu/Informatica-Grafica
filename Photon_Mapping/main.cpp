...
int main(int argc, char* argv[])
{
	...
	case 4:
	{
		Object3D* sphere1 = new Sphere(Vector3(0, 1, .0), 0.4, mirror);
		w->add_object(sphere1);


		Object3D* sphere2 = new Sphere(Vector3(-0.6, 0.3, 0.7), 0.3, green);
		w->add_object(sphere2);


		Object3D* sphere3 = new Sphere(Vector3(0.6, 1.6, 0.7), 0.3, red);
		w->add_object(sphere3);
	}
	break;
	case 5:
	{
		Object3D* sphere1 = new Sphere(Vector3(-0.4, 1.6, -0.6), 0.3, mirror);
		w->add_object(sphere1);


		Object3D* sphere2 = new Sphere(Vector3(0, 1, 0), 0.3, greenP);
		w->add_object(sphere2);


		Object3D* sphere3 = new Sphere(Vector3(0.4, 0.3, 0.7), 0.3, red);
		w->add_object(sphere3);
	}
	break;
	case 6:
